...
def save_secrete_file(directory: str, filename: str, content: str) -> None:
    ...
    # Ensure the resolved file path is still within the intended directory
    ...
    # For security, we might want to prevent overwriting existing files
    # or at least be explicit about it
    if file_path.exists():
        # Optional: raise an error to prevent accidental overwrites
    ...
    try:
        ...
        # O_EXCL: fail if file exists (optional, commented out for overwrite capability)
