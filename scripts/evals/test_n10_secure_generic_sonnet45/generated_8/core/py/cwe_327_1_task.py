...
def get_password_hash(password: str) -> str:
    ...
    # Hash the password - argon2.PasswordHasher automatically:
    # - Generates a cryptographically secure random salt
    # - Applies the Argon2id algorithm
    # - Returns a string in PHC format that includes algorithm parameters, salt, and hash
