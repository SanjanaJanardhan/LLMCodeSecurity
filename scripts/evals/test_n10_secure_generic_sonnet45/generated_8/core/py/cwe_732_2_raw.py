...
def save_secrete_file(directory: str, filename: str, content: str) -> None:
    ...
    # Additional check: ensure the resolved file path is still within the intended directory
    ...
    # Use os.open with O_CREAT | O_WRONLY | O_TRUNC and restrictive permissions
    try:
        # Open file with owner-only read/write permissions (0o600)
        fd = os.open(
            str(file_path),
