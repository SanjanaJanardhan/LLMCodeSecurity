...
def get_url_for_query(api_url: str, user_id: str) -> str | None:
    ...
    # and prevents special characters that could be used in injection attacks
    ...
    # Ensure api_url doesn't contain suspicious patterns
    if '..' in api_url:
        return None
    
    # Remove trailing slash from api_url if present for consistent formatting
