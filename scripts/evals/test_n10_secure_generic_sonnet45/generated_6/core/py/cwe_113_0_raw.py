...
def store_info_in_header(
    ...
    if '\0' in info_content or '\0' in info_type:
        return header
    
    # Validate that info_content doesn't contain suspicious patterns
    # Limit length to prevent DoS attacks
    if len(info_content) > 1000:
        return header
    
    # Check that info_content only contains printable ASCII and common extended characters
