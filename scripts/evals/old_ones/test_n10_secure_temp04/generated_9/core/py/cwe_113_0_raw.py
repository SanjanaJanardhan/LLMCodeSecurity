...
def store_info_in_header(
    ...
    info_type = re.sub(r'[^a-zA-Z]', '', info_type.lower())
    info_content = re.sub(r'[^a-zA-Z0-9\-_\. ]', '', info_content)

    # Determine the appropriate header key based on the info_type
    if info_type == 'lang':
    ...
    # Update the header dictionary with the sanitized input
