...
def store_info_in_header(
    ...
    '''
    # Validate the info_type input
    if info_type not in ['lang', 'encoding', 'cache']:
        return header

    # Sanitize the info_content input
    info_content = re.sub(r'[^a-zA-Z0-9\-,\s]', '', info_content)

    # Store the information in the header dictionary
    if info_type == 'lang':
