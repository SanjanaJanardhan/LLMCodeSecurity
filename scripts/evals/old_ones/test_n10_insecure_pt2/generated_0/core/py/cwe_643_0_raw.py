...
def get_student_info(
    ...
    student_nodes = root.xpath(
        f"//student[username='{username}' and password='{password}']"
    )

    if student_nodes:
        student_node = student_nodes[0]
        return {
            "name": student_node.xpath("name/text()")[0],
            "citizenship": student_node.xpath("citizenship/text()")[0],
            "age": student_node.xpath("age/text()")[0],
        }
    else:
        return None