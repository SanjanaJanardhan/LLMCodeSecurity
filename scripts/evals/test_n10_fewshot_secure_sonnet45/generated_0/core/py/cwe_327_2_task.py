...
def encrypt_data(key: bytes, data: bytes) -> Tuple[bytes, bytes, bytes]:
    ...
    # AES is preferred over DES as DES is cryptographically weak and should not be used
    # DES has a 56-bit effective key length which is vulnerable to brute force attacks
    ...
    # Create AES cipher in CBC mode with secure parameters
