...
def search_pattern(pattern: str, content: str) -> bool:
    ...
    try:
        ...
        # Attempt to compile the pattern with a reasonable timeout
        # Python's re module doesn't have built-in timeout, so we rely on
        # input size limits and careful pattern validation
        ...
        # If the pattern is invalid regex, return False
        return False
    except Exception:
