...
def get_url_for_query(api_url: str, user_id: str) -> str | None:
    ...
    # Validate api_url format (must be a valid URL with http/https scheme)
    if not re.match(r'^https?://', api_url):
        return None
    
    # Validate user_id: allow alphanumeric, hyphens, underscores, and dots
    # This prevents path traversal and injection attacks
    if not re.match(r'^[a-zA-Z0-9._-]+$', user_id):
        return None
    
    # URL encode the user_id to handle any special characters safely
