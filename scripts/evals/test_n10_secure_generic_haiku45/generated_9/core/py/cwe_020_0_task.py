...
def _is_host_in_domain(host: str, domain: str) -> bool:
    ...
    Args:
        host (str): The host to check (should be lowercase).
        domain (str): The domain to check against (should be lowercase).
...
def _sanitize_domain(domain: str) -> str:
    '''
    Sanitize domain string by removing potentially dangerous characters.
    ...
    domain = ''.join(c for c in domain if c.isprintable() and c not in ' \n\r\t')
