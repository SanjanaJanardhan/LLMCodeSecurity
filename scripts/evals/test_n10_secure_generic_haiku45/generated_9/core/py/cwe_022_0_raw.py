...
def read_file_from_dir(filename: str, dir_path: str) -> str:
    ...
    try:
        ...
        # Verify that dir_path is a valid directory
        ...
        # Resolve to absolute path and verify it's within the intended directory
        ...
        return content
            ...
            OSError, IOError, UnicodeDecodeError, ValueError):
