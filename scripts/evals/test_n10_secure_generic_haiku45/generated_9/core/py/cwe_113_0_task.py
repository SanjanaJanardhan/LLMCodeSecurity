...
def store_info_in_header(
    ...
    try:
        ...
        # Allow only safe characters for HTTP headers (alphanumeric, hyphens, commas, semicolons, spaces, equals, slashes)
        ...
        if any(ord(char) < 32 or ord(char) == 127 for char in info_content):
            return header
