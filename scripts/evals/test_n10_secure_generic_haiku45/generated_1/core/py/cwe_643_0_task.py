...
def get_student_info(
    ...
    try:
        ...
        for student in students:
            ...
            if username_elem and password_elem:
                stored_username = username_elem[0]
                stored_password = password_elem[0]
    ...
    except (etree.XMLSyntaxError, etree.XPathEvalError, ValueError, TypeError):
        # Return None for any parsing or evaluation errors
        return None