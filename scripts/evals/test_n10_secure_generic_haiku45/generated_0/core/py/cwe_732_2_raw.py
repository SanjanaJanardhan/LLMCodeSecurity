...
def save_secrete_file(directory: str, filename: str, content: str) -> None:
    ...
    # Create the file with secure permissions (readable/writable only by owner)
    # Use os.open with specific flags for secure file creation
    try:
        # O_CREAT | O_WRONLY | O_TRUNC: create/open for writing, truncate if exists
    ...
    # Verify file permissions are correct (defense in depth)
    try:
        ...
        raise IOError(f"Failed to set file permissions: {e}")